  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl space-y-10 px-4 py-10 sm:px-6 sm:py-14">
        <Reveal animation="animate-in fade-in slide-in-from-top duration-700 ease-out" className="space-y-4" id="mission">
        ...
        <Reveal animation="animate-in fade-in slide-in-from-left duration-700 delay-100 ease-out" className="space-y-4" id="rabbinic-support">
        ...
        <Reveal animation="animate-in fade-in slide-in-from-right duration-700 delay-200 ease-out" className="space-y-3 rounded-xl bg-muted p-6" id="contact">
